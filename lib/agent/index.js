...
class Agent {
  ...
  constructor ({ Eris, token, handlerData = {}, options = {} }) {
     ...
     */
    this._handlerData = {
      commands: this._formatHandlerData(commands),
      reactCommands: this._formatHandlerData(reactCommands),
      replacers: this._formatHandlerData(replacers),
      options: {
        prefix,
        replacerBraces,
        maxInterfaces
  ...
  /**
   * Build a guide embed for a specific command (Must be constructed with a longDesc)
   * @generator
  ...
  /**
   * Format handler data by turning existing single supply into arrays if necessary
   * @private
   * @param   {Array<Command|Replacer|ReactCommand>|Command|Replacer|ReactCommand} data The handler data
   * @returns {Array<Command|Replacer|ReactCommand>}                                    The formatted data
   */
  _formatHandlerData (data) {
