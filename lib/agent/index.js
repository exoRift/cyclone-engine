...
class Agent {
  ...
  addAttachment (name, value) {
    if (this._attachements[name]) throw Error('An attachment with that name is already added')

    this._attachements[name] = value
  ...
  removeAttachment (name) {
    const attachment = this._attachements[name]

    delete this._attachements[name]
