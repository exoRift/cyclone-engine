...
class Agent {
  ...
  constructor ({ Eris, token, handlerData = {}, options = {} }) {
     ...
     */
    this._handlerData = {
      commands: commands ? Array.isArray(commands) ? commands : [commands] : undefined,
      reactCommands: reactCommands ? Array.isArray(reactCommands) ? reactCommands : [reactCommands] : undefined,
      replacers: replacers ? Array.isArray(replacers) ? replacers : [replacers] : undefined,
      options: {
        prefix,
        replacerBraces,
        maxInterfaces
