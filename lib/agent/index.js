...
class Agent {
   ...
   * @prop  {String[]}                     [data.options.intents=[]]                          {@link https://discord.com/developers/docs/topics/gateway#list-of-intents} Additional intents to subscribe to for the gateway. (Intents are automatically calculated from agent features getting enabled. However, add additional intents if needed) (Eris supports snakeCase if CAMEL_CASE is not preferred)
