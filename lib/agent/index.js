...
class Agent {
  ...
  _onShardReady (client, shard) {
    ...
    if (this._statusMessage) {
      if (typeof this._statusMessage === 'function') this._statusMessage(this, shard, client.shards.get(shard).editStatus)
      else client.shards.get(shard).editStatus(this._statusMessage)
    } else {
