...
test('invalidChannel', async (t) => {
  ...
  return t.throwsAsync(t.context.handler.handle(await t.context.channels.dChannel.createMessage('!invalidchannel')), Error, 'DiscordRESTError [50035]: Invalid Form Body\n  channel_id: Value "undefined" is not snowflake.')
})
