...
class ReactionHandler {
   ...
   * @returns {Eris.Message}                              Overall results from the react command.
   */
   ...
   */
  _generateError (name, message, code) {
    const err = new Error(`${name} [${code}]: ${message}`)
