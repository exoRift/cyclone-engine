...
test('invalidChannel', async (t) => {
  ...
  return t.throwsAsync(t.context.handler.handle(t.context.message, await t.context.message.addReaction('🍕'), t.context.users.botOwner), Error, 'DiscordRESTError [50035]: Invalid Form Body\n  channel_id: Value "undefined" is not snowflake.')
})
