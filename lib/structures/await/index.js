...
class Await {
   ...
   * @prop  {Array<Object|String>}  [data.options.args=[]]             The arguments for the await (Can be an argument constructor data object or just the name of the argument). See the constructor of the Argument class {@link Argument}
