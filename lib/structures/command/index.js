...
class Command {
   ...
   * @prop  {Boolean}         [data.options.serverOnly=false] Whether or not this command can only be triggered in servers as opposed to DMs
  ...
  constructor ({ name, desc, options = {}, action }) {
     ...
     * @prop {Boolean}    serverOnly Whether or not this command can only be triggered in servers as opposed to DMs
